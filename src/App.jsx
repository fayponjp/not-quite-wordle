    ...
    function handleInput(letterInput) {
        !game.gameOver &&
            setLetters((prevLetters) => {
                ...
                currentLetters[game.guessRow] =
                    currentLetters[game.guessRow].length < 5
                        ? [...currentLetters[game.guessRow], letterInput]
                        : currentLetters[game.guessRow];
    ...
    function handleBackspace() {
        setLetters((prevLetters) => {
            ...
            if (currentLetters[game.guessRow].length > 0) {
                currentLetters[game.guessRow] = currentLetters[
                    game.guessRow
                ].slice(0, -1);
            }
            return currentLetters;
        ...
        if (letters[game.guessRow].length >= 5) {
            if (wordExists(currentWord)) {
                ...
                if (rowRef.current) {
                    ...
                    setTimeout(
                        () => rowRef.current.classList.remove('shake'),
                        250
                    );
                }
            }
    ...
    return (
        <>
            ...
            <div className='game'>
                ...
                <Modal game={game} letters={letters} word={word} />
            </div>
            <Guide/>
        </>
    );
